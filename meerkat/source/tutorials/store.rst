...
功能权限说明
--------------
查看当前门店各项报表数据，提取数据并进行数据分析。

功能权限概叙 
-------------
  1. 仪表盘：门店报表数据一览，所有数据全部在此页面显示。
  #. 报表一览：查看当前门店的报表数据。
  #. 店的信息：查看并编辑门店信息。
  #. 我的设备：查看当前门店设备信息。
  #. 节假日设置：查看并编辑节假日信息。
...
.. image:: _static/用户报表一览.png

查看报表数据

.. image:: _static/用户查看报表.png
...
.. image:: _static/用户店的信息.png

门店信息编辑界面

.. image:: _static/用户店编辑.png
...
.. image:: _static/用户设备管理.png

设备详情

.. image:: _static/设备详情.png
...
.. image:: _static/节假日主界面.png

添加节假日Excel界面

.. image:: _static/用户节假日添加.png

导入节假日Excel界面

.. image:: _static/导入节假日.png 
